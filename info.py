...
API_ID = int(environ.get('API_ID', '20592051'))  # Telegram API ID
API_HASH = environ.get('API_HASH', '5284ccb45f29e6f4ea408854a2ea8bbd')  # Telegram API Hash
BOT_TOKEN = environ.get('BOT_TOKEN', '')  # Telegram Bot Token

# 👑, Channels & Logs
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1003042522134'))  # File storage channel
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002732217390'))  # General log channel
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", '-1002732217390'))  # Premium user actions log
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002732217390'))  # Verified user actions log
...
OWNER_USERNAME = environ.get("OWNER_USERNAME", 'Pre_contact_bot')  # Owner's username
...
DB_URL = environ.get('DATABASE_URI', "mongodb+srv://koxiher824:uhWjdKAzmfAHcagy@cluster0.lg66r.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB connection URI
...
AUTH_PICS = environ.get('AUTH_PICS', 'https://graph.org/file/7952b44b614485ad1b9e6-4c8d62499c4f437068.jpg')  # Auth step image
PICS = environ.get('PICS', 'https://graph.org/file/7952b44b614485ad1b9e6-4c8d62499c4f437068.jpg')  # Default info image
FILE_PIC = environ.get('FILE_PIC', 'https://graph.org/file/7952b44b614485ad1b9e6-4c8d62499c4f437068.jpg') # file image 
